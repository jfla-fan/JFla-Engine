...
namespace Engine
{
	...
	template<typename _Resource_type, typename _Size_type, typename _Element_type, typename _Buffer_type, typename _Usage_type>
	...
	struct _Default_buffer_traits<_Vertex_buffer_tag>
	{
		...
		using resource_type = uint32;
		using size_type		= uint32;
		using element_type	= float;
		using buffer_type	= Graphics::EBufferType;
		using usage_type	= Graphics::EBufferUsage;
	};
